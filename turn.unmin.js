...
(function (f) {
    ...
    function P(a, b, c, d, e) {
        ...
        if ("-webkit-" == w) {
            ...
            for (h = 0; h < e; h++) f.push(" " + d[h][1] + " " + (100 * (b + g * d[h][0])) / x + "%");
            a.css({ "background-image": w + "linear-gradient(" + -i + "rad," + f.join(",") + ")" });
        }
    }
    function t(a, b, c) {
        a = f.Event(a);
    ...
    var z,
        ...
        r = u ? { down: "touchstart", move: "touchmove", up: "touchend", over: "touchstart", out: "touchend" } : { down: "mousedown", move: "mousemove", up: "mouseup", over: "mouseover", out: "mouseout" },
        p = { backward: ["bl", "tl"], forward: ["br", "tr"], all: "tl bl tr br l r".split(" ") },
        V = ["single", "double"],
        W = ["ltr", "rtl"],
        X = { acceleration: !0, display: "double", duration: 600, page: 1, gradients: !0, turnCorners: "bl,br", when: null },
        Y = { cornerSize: 100 },
        g = {
            init: function (a) {
                ...
                var d = this.data(),
                    e = this.children(),
                    a = f.extend({ width: this.width(), height: this.height(), direction: this.attr("dir") || this.css("direction") || "ltr" }, X, a);
                d.opts = a;
                d.pageObjs = {};
                d.pages = {};
                d.pageWrap = {};
            ...
            destroy: function () {
                ...
                if ("prevented" != t("destroying", this)) {
                    ...
                    for (f(document).unbind(r.move, b.eventHandlers.touchMove).unbind(r.up, b.eventHandlers.touchEnd); 0 !== b.totalPages; ) this.turn("removePage", b.totalPages);
            ...
            zoom: function (a) {
                var b = this.data();
                if ("number" == typeof a) {
                    if (0.001 > a || 100 < a) throw q(a + " is not a value for zoom");
        ...
        i = {
            ...
            options: function (a) {
                var b = this.data().f;
                return a ? (i.setData.call(this, { opts: f.extend({}, b.opts || Y, a) }), this) : b.opts;
            },
            z: function (a) {
                var b = this.data().f;
                b.opts["z-index"] = a;
            ...
            _cAllowed: function () {
                ...
                return "hard" == a.effect
                    ...
                    ? 1 == b
                        ...
                        : p.all
                    : "ltr" == c.direction
                    ? p[d ? "forward" : "backward"]
                    : p[d ? "backward" : "forward"];
            },
                ...
                switch (b.effect) {
                    ...
                    case "sheet":
                        a &&
                            ...
                            b.parent.is(":visible") && ((c = D(b.parent[0])), b.fwrapper.css({ top: c.top, left: c.left }), (c = D(b.opts.turn[0])), b.fparent.css({ top: -c.top, left: -c.left })),
            ...
            _fold: function (a) {
                ...
                switch (b.effect) {
                    case "hard":
                        ...
                        b.parent.css(q);
                        t ? ((p = -p + 1), b.wrapper.css({ zIndex: l + 1 }), b.fpage.css({ zIndex: l })) : ((p -= 1), b.wrapper.css({ zIndex: l }), b.fpage.css({ zIndex: l + 1 }));
                        c.opts.gradients &&
                            (g ? b.ashadow.css({ display: "", left: f, backgroundColor: "rgba(0,0,0," + 0.5 * p + ")" }).transform("rotateY(0deg)") : b.ashadow.hide(),
                            b.bshadow.css({ opacity: -p + 1 }),
                            t ? b.bshadow.parent()[0] != b.wrapper[0] && b.bshadow.appendTo(b.wrapper) : b.bshadow.parent()[0] != b.fpage[0] && b.bshadow.appendTo(b.fpage),
                            P(
                                b.bshadow,
                                j(100 * s, 0),
                                j(100 * (-s + 1), 0),
                    ...
                    case "sheet":
                        ...
                        var O = c.opts.acceleration,
                            ...
                            I = function () {
                                ...
                                c.opts.gradients &&
                                    ((y = b * Math.sin(g)),
                                    (b = i._c2.call(u, a.corner)),
                                    (b = Math.sqrt(Math.pow(b.x - a.x, 2) + Math.pow(b.y - a.y, 2)) / e),
                                    (D = Math.sin(L * (1 < b ? 2 - b : b))),
                                    (N = Math.min(b, 1)),
                                    (M = 100 < y ? (y - 100) / y : 0),
                                    (A = j(100 * ((y * Math.sin(g)) / e), 100 * ((y * Math.cos(g)) / h))),
                                    i._backGradient.call(u) && ((B = j(100 * ((1.2 * y * Math.sin(g)) / e), 100 * ((1.2 * y * Math.cos(g)) / h))), C || (B.x = 100 - B.x), E || (B.y = 100 - B.y)));
                                m.x = Math.round(m.x);
                                m.y = Math.round(m.y);
                                return !0;
                            };
                        f = function (a, d, f, g) {
                            ...
                            c.opts.gradients &&
                                (f[0] && (A.x = 100 - A.x),
                                f[1] && (A.y = 100 - A.y),
                                (k["box-shadow"] = "0 0 20px rgba(0,0,0," + 0.5 * D + ")"),
                                J.css(k),
                                P(
                                    b.ashadow,
                                    j(C ? 100 : 0, E ? 0 : 100),
